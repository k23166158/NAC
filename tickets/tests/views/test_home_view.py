...
class HomeViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.s1 = User.objects.create_user(username="s1", email="s1@e.com", password="p", is_staff=True)
        self.s2 = User.objects.create_user(username="s2", email="s2@e.com", password="p", is_staff=True)
